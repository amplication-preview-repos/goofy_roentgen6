...
export class FeaturesResolverBase {
  ...
  async createFeatures(
    ...
    return await this.service.createFeatures({
      ...
      data: {
        ...
        bodyType: args.data.bodyType
          ? {
              connect: args.data.bodyType,
            }
          : undefined,

        face: args.data.face
          ? {
              connect: args.data.face,
            }
          : undefined,

        hairColor: args.data.hairColor
          ? {
              connect: args.data.hairColor,
            }
          : undefined,
      },
    });
  ...
  @graphql.ResolveField(() => BodyType, {
    nullable: true,
    name: "bodyType",
  })
  async getBodyType(
    @graphql.Parent() parent: Features
  ): Promise<BodyType | null> {
    const result = await this.service.getBodyType(parent.id);
  ...
  @graphql.ResolveField(() => Face, {
    nullable: true,
    name: "face",
  })
  async getFace(@graphql.Parent() parent: Features): Promise<Face | null> {
    const result = await this.service.getFace(parent.id);
  ...
  @graphql.ResolveField(() => HairColor, {
    nullable: true,
    name: "hairColor",
  })
  async getHairColor(
    ...
    const result = await this.service.getHairColor(parent.id);
